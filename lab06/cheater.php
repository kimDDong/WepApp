...
<html lang="en">
	...
	?>
		...
		if(!(isset($name) and isset($id) and isset($course) and isset($grade) and isset($cardnumber) and isset($cardtype))
			or !($name != "" and $id != "" and $cardnumber != "")
		){
		?>
		<!-- Ex 4 : 
		...
		# Check if the Visa card starts with 4 and MasterCard starts with 5. 
			...
			or ($cardtype == "Visa" and !(preg_match("/^4/", $cardnumber)))
			or ($cardtype == "MasterCard" and !(preg_match("/^5/", $cardnumber)))
		){
		?>
		...
		<?php
			 ...
			 */
			$looser_data = $name.';'.$id.';'.$cardnumber.';'.$cardtype."\n";
			file_put_contents($filename, $looser_data, $flags = FILE_APPEND);
		?>
